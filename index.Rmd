...
If you want ready-to-use working environment for R, follow this [tutorial](https://frbcesab.github.io/rsetup). For this course, you just need to install [`R`](https://cran.r-project.org/) and [`RStudio`](https://posit.co/download/rstudio-desktop/) (optional).

You also need to install R package [`RStan`](https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started).
