...
description: "FRB-CESAB & GdR TheoMoDive training course"
author:
...
The second edition of this training course took place from the 3rd to the 
...
`09:00-10:30` - Courses<br/>
`10:30-10:45` - _Coffee break_<br/>
`10:45-12:30` - Courses<br/>
`12h30-14:00` - _Lunch_<br/>
`14:00-15:30` - Practices<br/>
`15:30-15:45` - _Coffee break_<br/>
`15:45-17:30` - Practices<br/>
...
<br/>&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
**_Guest speaker_**: Davide Martinetti (INRAE, Avignon)
